...
class SettingsViewModel(val activity: MainActivity) {
    ...
    fun initializeState(
        ...
        memoryManagerMode.value = MemoryManagerMode.entries.getOrElse(
            sharedPref.getInt("memoryManagerMode", SettingsDefaults.memoryManagerMode.ordinal)
        ) { SettingsDefaults.memoryManagerMode }
        useNce.value = sharedPref.getBoolean("useNce", SettingsDefaults.useNce)
        memoryConfiguration.value = MemoryConfiguration.entries.getOrElse(
            sharedPref.getInt("memoryConfiguration", SettingsDefaults.memoryConfiguration.ordinal)
        ) { SettingsDefaults.memoryConfiguration }
        vSyncMode.value = VSyncMode.entries.getOrElse(
            sharedPref.getInt("vSyncMode", SettingsDefaults.vSyncMode.ordinal)
        ) { SettingsDefaults.vSyncMode }
        enableDocked.value = sharedPref.getBoolean("enableDocked", SettingsDefaults.enableDocked)
        enablePptc.value = sharedPref.getBoolean("enablePptc", SettingsDefaults.enablePptc)
        enableLowPowerPptc.value = sharedPref.getBoolean("enableLowPowerPptc", SettingsDefaults.enableLowPowerPptc)
        enableJitCacheEviction.value = sharedPref.getBoolean("enableJitCacheEviction", SettingsDefaults.enableJitCacheEviction)
        ...
        enableShaderCache.value = sharedPref.getBoolean("enableShaderCache", SettingsDefaults.enableShaderCache)
        enableTextureRecompression.value = sharedPref.getBoolean("enableTextureRecompression", SettingsDefaults.enableTextureRecompression)
        enableMacroHLE.value = sharedPref.getBoolean("enableMacroHLE", SettingsDefaults.enableMacroHLE)
        ...
        enablePerformanceMode.value = sharedPref.getBoolean("enablePerformanceMode", SettingsDefaults.enablePerformanceMode)
